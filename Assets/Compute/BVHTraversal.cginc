...
void TraverseBVHIterative(internalNode leaf, float radius, out int collisionList[64])
{
    ...
    while (!solved && maxLoop < log2(count) * log2(count))
    {
        internalNode childA;
        internalNode childB;
        ...
        //if (!isLeaf(childA) && AABBOverlap(leaf.minPos - AABBRadius, leaf.maxPos + AABBRadius, boundingLeafNodes[childA.bLeaves.y].minPos, boundingLeafNodes[childA.bLeaves.y].maxPos))
        //    overlapA = false;
        //    
        //if (!isLeaf(childB) && AABBOverlap(leaf.minPos - AABBRadius, leaf.maxPos + AABBRadius, boundingLeafNodes[childB.bLeaves.y].minPos, boundingLeafNodes[childB.bLeaves.y].maxPos))
        //    overlapB = false;
